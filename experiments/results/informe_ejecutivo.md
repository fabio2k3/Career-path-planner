...
_Generado automáticamente el 2026-06-09 06:51:56_

## Resumen comparativo A* vs Greedy

| Algoritmo | Instancias | Éxito | Cursos prom. | Semanas prom. | Nodos prom. | Tiempo prom. (s) | Tray. válidas |
| --- | --- | --- | --- | --- | --- | --- | --- |
| A* | 8 | 100.0% | 9.12 | 40.00 | 21717.88 | 2.0454 | 100.0% |
| Greedy | 8 | 100.0% | 9.25 | 39.50 | 270.00 | 0.0205 | 100.0% |

## Análisis de la evaluación LLM

La puntuación media del LLM fue **8.40/10** (mínimo 8.00, máximo 9.00).

Todas las trayectorias evaluadas resultaron concisas; el LLM no aplicó penalización por extensión en este conjunto.
...
| Métrica | Valor |
| --- | --- |
| Puntuación media | 8.40/10 |
| Puntuación mínima | 8.00/10 |
